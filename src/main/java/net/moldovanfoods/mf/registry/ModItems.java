...
public class ModItems {
    ...
    public static final Item CASTRON_DE_PELIMENE = register("castron_de_pelimene", Item.Properties::new);
    ...
    public static final Item LAVAS = register("lavas", () -> new Item.Properties()
            .food(new FoodProperties.Builder()
                    .nutrition(3)
